...
fn dark_theme() -> Theme {
    Theme {
        ...
        positive_dim: Color::Rgb(21, 88, 64),
        negative: Color::Rgb(248, 113, 113),
        negative_dim: Color::Rgb(96, 38, 38),
        warning: Color::Rgb(245, 158, 11),
        surface: Color::Rgb(24, 24, 24),
        border_dim: Color::Rgb(58, 58, 58),
...
fn light_theme() -> Theme {
    Theme {
        ...
        positive_dim: Color::Rgb(190, 224, 208),
        negative: Color::Rgb(184, 28, 28),
        negative_dim: Color::Rgb(234, 194, 194),
        warning: Color::Rgb(168, 104, 0),
        surface: Color::Rgb(232, 231, 225),
        border_dim: Color::Rgb(196, 194, 186),
...
fn transparent_theme() -> Theme {
    Theme {
        ...
        positive_dim: Color::Rgb(26, 90, 52),
        negative: Color::Rgb(248, 113, 113),
        negative_dim: Color::Rgb(96, 38, 38),
        warning: Color::Rgb(251, 191, 36),
        surface: Color::Reset,
        border_dim: Color::Rgb(72, 72, 72),
...
fn bloomberg_theme() -> Theme {
    Theme {
        ...
        positive_dim: Color::Rgb(0, 78, 52),
        negative: Color::Rgb(255, 84, 84),
        negative_dim: Color::Rgb(92, 28, 28),
        warning: Color::Rgb(255, 168, 0),
        surface: Color::Rgb(18, 18, 18),
        border_dim: Color::Rgb(70, 52, 34),
